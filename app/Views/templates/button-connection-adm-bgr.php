    ...
    <li class="nav-item dropdown" id="admMenu">
        <div>
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <!-- vet -->
                <?php elseif(isset($_SESSION['role']) && $_SESSION['role'] === 'vétérinaire'): ?>
                    <li><a class="dropdown-item <?= $uriParts[1] == 'admVet' ? 'active' : '' ?>"a href="/admVet/view">Rapports vétérinaire</a></li>
                <!-- employee -->
                <?php elseif(isset($_SESSION['role']) && $_SESSION['role'] === 'employé'): ?>
                    <li><a class="dropdown-item <?= $uriParts[1] == 'admFeedings' ? 'active' : '' ?>" href="/admFeeding/view">Nourrissages</a></li>
                    <li><a class="dropdown-item <?= $uriParts[1] == 'admComments' ? 'active' : '' ?>" href="/admComments/view">Avis</a></li>
                <?php endif; ?>
                <li><hr class="dropdown-divider"></li>
...
<?php else : ?>
    <div class="dropdown">
        ...
        <form method="post" class="dropdown-menu p-4" id="login-form-bgr">
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary" id="login-button-bgr">Connecter</button>
    </form>
    </div>
<?php endif; ?>