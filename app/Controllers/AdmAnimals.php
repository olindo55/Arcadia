...
{   
    ...
    public function put()
    {
        ...
        if (isset($request['id'], $request['name'], $request['description'], $request['image_url'], $request['image_url_hd'], $request['image_alt'])) {
            ...
            $query = DbUtils::getPdo()->prepare("UPDATE animal SET name = :name , description = :description , image_url = :image_url , image_url_hd = :image_url_hd , image_alt = :image_alt WHERE id = :id");
    ...
    {   
        ...
        if (isset($request['id'])) {
            // get url of images
            $query = DbUtils::getPdo()->prepare('SELECT image_url, image_url_hd FROM animal WHERE id = :id');
